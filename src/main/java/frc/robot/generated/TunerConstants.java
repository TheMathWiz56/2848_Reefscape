...
public class TunerConstants {
    ...
    private static final TalonFXConfiguration steerInitialConfigs = new TalonFXConfiguration()
        ...
        ).withMotorOutput(new MotorOutputConfigs().withDutyCycleNeutralDeadband(0.05)); // help prevent steer jitter during lifted testing. Should be removed for ground testing
