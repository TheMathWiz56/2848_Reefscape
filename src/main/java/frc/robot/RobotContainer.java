...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        testingJoystick.a().onTrue(commandFactory.autoPathfindCoralLeft(7).until(() -> manualDrivebase.getAsBoolean()));
        testingJoystick.b().onTrue(commandFactory.autoPathfindCoralRight(7).until(() -> manualDrivebase.getAsBoolean()));
