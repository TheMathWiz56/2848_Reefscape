...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        testingJoystick.a().onTrue(commandFactory.autoPathfindCoralLeft(6).until(() -> manualDrivebase.getAsBoolean()));
        testingJoystick.b().onTrue(commandFactory.autoPathfindCoralRight(6).until(() -> manualDrivebase.getAsBoolean()));
