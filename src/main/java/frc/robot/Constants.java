...
public final class Constants {
    ...
    public static class ArmConstants {
        ...
        public static final double kReefAlgaeHigh2nd = 0.0;
    ...
    public static class PincerConstants {
        ...
        public static final int kLaserCanId = 10;
            ...
            public static final double kPincerMotorAbsoluteEncoderOffset = .35; // Zero with the claw all the way stowed (minus a bit more)
            ...
            // Pincer Setpoints
            public static final double kStowPosition = 0.15; // All temporary for now
            public static final double kFunnelPosition = 0.65;
            public static final double kFunnel2Position = 0.5;
            public static final double kAlgaePosition = 0.2;
        ...
        public static class ElevatorConstants {
            ...
            public static final double autoReProfileThreshold = 5.0;
